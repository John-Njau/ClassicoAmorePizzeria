...
$().ready(function () {
  ...
  $("#delivery").click(function () {
    ...
    $("#totalPayment").click(function (event) {
      ...
      if (location != "" && phoneNumber != "") {
        $(".finally").append(
          '<i class="fas fa-check-circle m-5" style="font-size:80px;color:green;"></i>' +
            "<br>" +
            "<p>" +
            `Your Payment of ${checkoutTotalDel}/= has been received.Your Delivery will be Dispatched to ${location}.Keep it Classico Amore. Enjoy!` +
            "<p/>"
        );
  ...
  $("#pickUp").click(function () {
    ...
    $("#totalAmountPickUp").click(function () {
      ...
      $(".finallyPicked").append(
        '<i class="fas fa-check-circle m-5" style="font-size:80px;color:green;"></i>' +
          "<br>" +
          "<p>" +
          `Your Payment of ${checkoutTotal}/= has been received.Your Order will be ready for Pick up in 20mins.Keep it Classico Amore. Enjoy!` +
          "<p/>"
      );
